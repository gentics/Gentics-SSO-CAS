...
public class PasswordChangePortlet extends AbstractGenticsPortlet {
	...
	private String validateToken(final String token) throws PortletException, ExpressionParserException, DatasourceException {
	...
	private Resolvable getResolvableForToken(final String token, Datasource ds) throws PortletException, ExpressionParserException,
			DatasourceException {
		if (token == null) {
